      ...
      <div className="bg-slate-900 rounded-2xl border border-slate-700 w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-lg text-white">Environment Variables</h2>
            ...
            <div className="space-y-2">
              {Object.entries(envData.variables).map(([key, value]) => (
                <div key={key} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-[2] bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-300 font-mono focus:outline-none focus:border-indigo-500"
                    title={`Value for ${key}`}
                  />
                  <button
              ...
              <div className="flex items-center gap-2 pt-4 border-t border-slate-700 mt-4">
                <input
                  ...
                  placeholder="NEW_KEY"
                  className="flex-1 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-300 font-mono placeholder-slate-500 focus:outline-none focus:border-indigo-500"
                ...
                <input
                  ...
                  placeholder="value"
                  className="flex-[2] bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-300 font-mono placeholder-slate-500 focus:outline-none focus:border-indigo-500"
